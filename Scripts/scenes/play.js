...
(function (scenes) {
    var Play = (function (_super) {
        ...
        Play.prototype._rollButtonClick = function (event) {
			// This removes the already present dice numbers when function is called again
			...
			//Displays to console which random numbers are called
            console.log("Rolled " + this._currentRolls);
            // Add corresponding die images to scene
			// When random number is rolled image for corresponding roll is called 
			...
			// This just displays rolled number in string just below the dice
